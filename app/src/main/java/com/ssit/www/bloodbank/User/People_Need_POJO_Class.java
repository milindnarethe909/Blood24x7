...
public class People_Need_POJO_Class {
    ...
    @SerializedName("donar_search_date")
    @Expose
    private String donarSearchDate;
    ...
    public String getDonarSearchDate() {
        return donarSearchDate;
    }

    public void setDonarSearchDate(String donarSearchDate) {
        this.donarSearchDate = donarSearchDate;
    }
